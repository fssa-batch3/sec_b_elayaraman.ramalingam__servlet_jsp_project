...
<body>
	...
	<div class="container d-flex align-item-center h-80">
		<form id="mainForm" class=" needs-validation d-flex flex-column m-auto w-50"
			...
			<input type="hidden" name="travelDate"
				value="<%=busDetails.getTravelDate()%>">
			...
			<div class="col mt-4">
				<button type="button" class="btn-primary btn" data-bs-toggle="modal" data-bs-target="" id="bookNowButton">Book Now</button>
		      ...
		      <div class="modal-body">
		        ...
		        <form id="mockPaymentForm" novalidate>
		          ...
		          <div class="mb-3">
		            ...
		            <input type="text" class="form-control" id="amountToBePaid" name="amountToBePaid" readonly>
		          </div>
		          <button type="button" id="payment" class="btn btn-primary">Pay Now</button>
		        </form>
		      </div>
	...
	document.getElementById("seatCount").addEventListener('input',e =>{
